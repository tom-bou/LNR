...
from .base_optimizer_selmix import MetricOptimizer

class MeanRecall(MetricOptimizer):
    def __init__(self, CM, prototypes, model, classifier, lws_model, DistTemp=0.1, lambda_min=0.6):
        super().__init__(CM, prototypes, model, classifier, lws_model, DistTemp=DistTemp, lambda_min=lambda_min)
...
class MinRecall(MetricOptimizer):
    def __init__(self, CM, prototypes, model, classifier, lws_model,DistTemp=1.0,\
...
class Gmean(MetricOptimizer):
    def __init__(self, CM, prototypes, model, classifier, lws_model,DistTemp=1.0,  lambda_min=0.6):
        super().__init__(CM, prototypes, model, classifier, lws_model,DistTemp=DistTemp, lambda_min=lambda_min)
